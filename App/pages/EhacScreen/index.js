        ...
        <View style={styles.box}>
          <View style={styles.itemcovid}>
            ...
            <View style={styles.textcovid}>
              <Text style={styles.judulcovid}>Buat e-HAC</Text>
          ...
          <View style={styles.itemcheck}>
            ...
            <View style={styles.textcheck}>
              <Text style={styles.judulcheck}>e-HAC saya</Text>
              <Text style={styles.isicheck}>Cek seluruh riwayat e-HAC yang pernah dibuat di sini</Text>
            </View>
          </View>
        </View>
